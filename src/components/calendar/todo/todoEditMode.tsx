        ...
        <div>
          ...
          <div className="flex flex-col lg:flex-row items-center my-[13px]">
            <div>
              ...
              <input
                className="ml-[11px] lg:ml-[12px] w-[220px] lg:w-[124px] h-[30px] text_base bor rounded-md px-[8px] py-[6px] outline-none placeholder:text-[#C2BFBC] lg:mr-[8px] disabled cursor-not-allowed text-center"
                disabled
