...
const config: Config = {
  ...
  safelist: [
    {
      pattern: /my-./, // my-로 시작하는 모든 클래스 이름은 제거되지 않음
    },
  ],
  darkMode: "class",
  theme: {
    fontFamily: {
      satoshi: ["Pretendard-Regular", "Satoshi", "sans-serif"],
    },
    screens: {
      "2xsm": "375px",
      xsm: "425px",
    ...
    extend: {
      ...
      gridTemplateColumns: {
        ...Array.from({ length: 101 }, (_, i) => i + 1).reduce(
          (obj: any, num) => {
            obj[num] = `repeat(${num}, minmax(0, 1fr))`;
            return obj;
          },
          {}
        ),
